...
#define PFM_BUILDTAG pfm.1.0.0.171
#define PFM_BUILDTAGA "pfm.1.0.0.171"
#define PFM_BUILDTAGW L"pfm.1.0.0.171"

#define PFM_APIBASENAMEW L"pfmapi"
#define PFM_APIFILENAMEW L"pfmapi." PT_PLUGINEXTW
#define PFM_CMDBASENAMEW L"pfm"
#define PFM_CMDFILENAMEW L"pfm" PT_EXESUFFIXW
